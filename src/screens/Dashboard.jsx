              ...
              <div className="col-span-12 intro-y items-center">
                ...
                <Alert className="box bg-success text-white flex items-center mb-6">
                  {({ dismiss }) => (
                    <>
                      <span>
                        Hello {user?.firstName}, Enjoy the full benefit of an Own-Earner by reffering others. <a style={{color:"#541484", fontWeight:"bolder", cursor: "pointer"}} onClick={() => dispatch(setRefferalLinkModal({status: true}))}>Click here</a> for your referal link
                      </span>
